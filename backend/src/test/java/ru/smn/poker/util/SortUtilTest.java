...
public class SortUtilTest {
    ...
    @BeforeEach
    public void before() {
        final PlayerEntity button = new PlayerEntity(faker.name().name());
        button.setButton();
        final PlayerEntity sm = new PlayerEntity(faker.name().name());
        sm.setRole(RoleType.SMALL_BLIND);
        final PlayerEntity bb = new PlayerEntity(faker.name().name());
        bb.setRole(RoleType.BIG_BLIND);
        final PlayerEntity simplePlayer = new PlayerEntity(faker.name().name());
    ...
    public void testSortPreflop() {
        ...
        final PlayerEntity simplePlayer1 = new PlayerEntity(faker.name().name());
        simplePlayer1.setRole(RoleType.ORDINARY);

        final PlayerEntity simplePlayer2 = new PlayerEntity(faker.name().name());
        ...
        final PlayerEntity simplePlayer3 = new PlayerEntity(faker.name().name());
        simplePlayer3.setRole(RoleType.ORDINARY);

        final PlayerEntity simplePlayer4 = new PlayerEntity(faker.name().name());
        simplePlayer4.setRole(RoleType.ORDINARY);

        final PlayerEntity simplePlayer5 = new PlayerEntity(faker.name().name());
